...
const sections = [
  {
    ...
    items: [
      ...
      ['支払いを間違えて登録した場合はどうすればよいですか？', '支払い一覧の「編集」から、内容・支払った人・金額・備考・負担するメンバーを変更し、「変更を保存」を押してください。添付済みの画像はそのまま残り、合計と精算額も更新されます。'],
    ],
  },
  {
    title: '共有・保存期限',
    items: [
      ...
      ['共有したページは誰でも編集できますか？', 'その割り勘のURLを知っている人は、内容の閲覧・追加・編集・削除ができます。閲覧専用の権限はありません。URLは一緒に精算するメンバーに共有してください。'],
